...
import'package:project/api/api_download_report.dart';
import 'package:project/model/downloadReport.dart';
...
class _AdminPageState extends State<AdminPage> {
  ...
  Widget build(BuildContext context) {
     if (currentPage == DrawerSections.campaign_insert) {
      ...
      }else if (currentPage == DrawerSections.FeedbackDetailsPage) {
      Future.delayed(Duration.zero, () {
        Navigator.of(context).push(
          MaterialPageRoute(builder: (context) => FeedbackDetailsPage()),
        );
      });
