...
router.route('/admin/downloadreport').copy(async(request,response)=>{
    var sql="COPY (select * from demodata) TO 'D:\Plant_template_Output.csv' DELIMITER ',' CSV HEADER";
    var res1= await config.query(sql,
    (err, res)=>{
